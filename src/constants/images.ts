...
const deal_off = require('../../assets/images/deal_off.jpg');
...
const logo_uit_cake = require('../../assets/images/logo_uit_cake.png');
const get_started = require('../../assets/images/get_started.png');
export default {
  cover,
  deal_off,
  flat,
